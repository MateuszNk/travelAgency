...
import io.github.MateuszNk.database.CheckLoginData;
...
public class LoginPanel {
    ...
    public void addActionsListeners() {
        frame.getRootPane().setDefaultButton(loginJButton);
        ...
        loginJButton.addActionListener(e -> {
            if ( new CheckLoginData(loginJTextField.getText(),
                    String.valueOf(passwordJPasswordField.getPassword())).getIsCorrectData() ) {
                frame.dispose();
            }
        });
    }
